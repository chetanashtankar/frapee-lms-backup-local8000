  ...
  methods: {
    ...
    toggleChat() {
      ...
      if (this.isChatOpen) {
        ...
        //   chatArea.innerHTML = `
        //     <div class="welcome-message">💬 Start a conversation with LMS Assistant!</div>
        //   `;
        // }
...
.chat-toggle {
  ...
  width: 60px;
  height: 60px;
  background: #083279 url(/files/bot1.svg) center center no-repeat;
  color: white;
  border: none;
  border-radius: 50%;
  font-size: 24px;
...
.chat-toggle:hover {
  ...
  box-shadow: 0 12px 35px rgba(8, 50, 121, 0.4);
...
.chatbot-container.fullscreen {
  ...
  border-radius: 10px; /* Optional: gives it a neat look */
}
...
.chatbot-header {
  background: linear-gradient(to bottom, #083279 0%, #0D4C91 50%, #1A6BBF 100%);
...
.send-btn {
  background: linear-gradient(135deg, #083279 0%, #0a4099 100%);
  color: white;
  font-weight: bold;
